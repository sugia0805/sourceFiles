...
createtime,
case
when province in ('北京市','上海市','北京','上海') or city in ('广州市','深圳市','广州','深圳') then 1
when province in ('广东省','湖北省','湖南省','河南省','山东省','山西省','贵州省',
                  '广东','湖北','湖南','河南','山东','山西','贵州') then 2
when province in ('安徽省','福建省','辽宁省','吉林省','广西壮族自治区','重庆市',
                  '安徽','福建','辽宁','吉林','广西','重庆') then 3
when province in ('云南省','河北省','江苏省','陕西省','江西省','浙江省','黑龙江省','四川省','天津市','海南省','甘肃省',
